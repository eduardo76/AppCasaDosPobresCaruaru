...
class AgendarDoacaoDao {
    ...
    public static function insertAgendarDoacao(AgendarDoacao $doacao){
        ...
        $sql = AgendarDoacao::pdo()->prepare("INSERT INTO agendamento_doacao 
                                                  (item, id_doador, quantidade, date, hora, lugar, id_tipo_doacao, telefone)
                                                  VALUES (:item, :doador, :quantidade, :data, :hora, :lugar, :id_tipo_doacao, :telefone)");
        ...
        $sql->bindValue(":telefone", $doacao->getTelefone());
        $sql->execute();
